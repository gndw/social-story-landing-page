    ...
    <Wrapper id="projects">
      <div className="whiteBg">
        <div className="container">
          <HeaderInfo>
            <h1 className="font40 extraBold">Cerita Pilihan Kami</h1>
            <p className="font13">
              Berbagai pilihan cerita yang dapat dimainkan
            </p>
          </HeaderInfo>
        ...
        <div className="container">
          <Advertising className="flexSpaceCenter">
            ...
            <AddRight>
              ...
              <h2 className="font40 extraBold">Membuat Ceritamu Sendiri</h2>
              <p className="font12">
                Ingin membuat cerita impianmu sendiri? Kamu dapat membuat ceritamu sendiri dan dimainkan oleh banyak orang.
              </p>
